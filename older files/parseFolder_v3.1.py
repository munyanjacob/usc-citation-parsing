...
#	**Producing spreadsheet version 4.1**
col_width = 130
...
citationsSheet0.set_column('A:D', col_width / 5)
...
citationsSheet1.set_column('A:D', col_width / 5)
...
citationsSheet2.set_column('A:D', col_width / 5)
...
citationsSheet3.set_column('A:D', col_width / 5)
...
citationsSheet4.set_column('A:D', col_width / 5)
