			...
			if re.search(regex1, opinion['text']):
				for r in re.findall(regex1, opinion['text']):
					...
					if 'U.S. Code Con' not in r[0] and 'U.S. Code & Con' not in r[0] and 'U.S.C.C.A.N' not in r[0] and 'U.S.Code Con' not in r[0]:
						...
						sheets[category].write(totalCounts[category], 3, caseCitation)
						sheets[category].write(totalCounts[category], 4, r[0], wrap)
						...
						if foundStat:
							...
							mixedcitationsSheet.write(mixedtotalCount, 0, caseYear)
							mixedcitationsSheet.write(mixedtotalCount, 1, caseCourtAbbrev)
							mixedcitationsSheet.write(mixedtotalCount, 2, title)
							mixedcitationsSheet.write(mixedtotalCount, 3, caseCitation)
							mixedcitationsSheet.write(mixedtotalCount, 4, r[0], wrap)
